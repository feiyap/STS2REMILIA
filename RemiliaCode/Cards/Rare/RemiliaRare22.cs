...
public class RemiliaRare22() : RemiliaCard(1,
    CardType.Power, CardRarity.Rare,
    TargetType.Self)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<RemiliaRare22Power>(1)];
    ...
    {
        base.DynamicVars["RemiliaRare22Power"].UpgradeValueBy(1m);
    }
}