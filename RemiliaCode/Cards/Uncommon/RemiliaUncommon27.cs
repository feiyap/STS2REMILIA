    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<RemiliaUncommon27Power>(choiceContext, base.Owner.Creature, base.DynamicVars["RemiliaUncommon27Power"].BaseValue, base.Owner.Creature, this);
    }
