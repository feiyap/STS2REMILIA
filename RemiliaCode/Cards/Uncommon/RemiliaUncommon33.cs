    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<RemiliaUncommon33Power>(choiceContext, base.Owner.Creature, base.DynamicVars["RemiliaUncommon33Power"].BaseValue, base.Owner.Creature, this);
    }
