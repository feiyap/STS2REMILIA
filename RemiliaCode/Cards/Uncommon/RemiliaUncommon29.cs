    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<RemiliaUncommon29Power>(choiceContext, base.Owner.Creature, base.DynamicVars["RemiliaUncommon29Power"].BaseValue, base.Owner.Creature, this);
    }
