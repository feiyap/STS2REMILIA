    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<RemiliaUncommon31Power>(choiceContext, base.Owner.Creature, base.DynamicVars["RemiliaUncommon31Power"].BaseValue, base.Owner.Creature, this);
    }
