    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<RemiliaUncommon35Power>(choiceContext, base.Owner.Creature, base.DynamicVars["RemiliaUncommon35Power"].BaseValue, base.Owner.Creature, this);
    }
