    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<RemiliaUncommon30Power>(choiceContext, base.Owner.Creature, base.DynamicVars["RemiliaUncommon30Power"].BaseValue, base.Owner.Creature, this);
    }
